...
class _View_MessagesComponent0 extends import1.AppView<import3.MessagesComponent> {
  ...
  _MessageListComponent_8_4:import11.MessageListComponent;
  _text_9:any;
  _text_10:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_8 = this.renderer.createElement(this._el_6,'app-message-list',(null as any));
    this._appEl_8 = new import2.AppElement(8,6,this,this._el_8);
    var compView_8:any = import14.viewFactory_MessageListComponent0(this.viewUtils,this.injector(8),this._appEl_8);
    this._MessageListComponent_8_4 = new import11.MessageListComponent(this.parentInjector.get(import13.MessageService));
    this._appEl_8.initComponent(this._MessageListComponent_8_4,[],compView_8);
    compView_8.create(this._MessageListComponent_8_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import11.MessageListComponent) && (8 === requestNodeIndex))) { return this._MessageListComponent_8_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._MessageInputComponent_3_4.ngOnInit(); }
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._MessageListComponent_8_4.ngOnInit(); }
...
export function viewFactory_MessagesComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessagesComponent> {
  if ((renderType_MessagesComponent === (null as any))) { (renderType_MessagesComponent = viewUtils.createRenderComponentType('C:/Users/lisac/Documents/Angular2andNodejs/seed-project/assets/app/messages/messages.component.ts class MessagesComponent - inline template',0,import8.ViewEncapsulation.None,styles_MessagesComponent,{})); }
