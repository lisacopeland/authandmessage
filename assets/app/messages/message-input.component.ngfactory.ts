...
class _View_MessageInputComponent0 extends import1.AppView<import3.MessageInputComponent> {
  ...
  _RequiredValidator_10_4:import14.RequiredValidator;
  _NG_VALIDATORS_10_5:any[];
  _NG_VALUE_ACCESSOR_10_6:any[];
  _NgModel_10_7:import15.NgModel;
  _NgControl_10_8:any;
  _NgControlStatus_10_9:import12.NgControlStatus;
  _text_11:any;
  _text_12:any;
  _el_13:any;
  _text_14:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_3 = this.renderer.createElement(this._el_1,'form',(null as any));
    ...
    this._NgModel_10_7 = new import15.NgModel(this._ControlContainer_3_4,this._NG_VALIDATORS_10_5,(null as any),this._NG_VALUE_ACCESSOR_10_6);
    ...
    this._el_13 = this.renderer.createElement(this._el_3,'button',(null as any));
    ...
    this._text_14 = this.renderer.createText(this._el_13,'Clear',(null as any));
    this._text_15 = this.renderer.createText(this._el_3,'\n		',(null as any));
    this._el_16 = this.renderer.createElement(this._el_3,'button',(null as any));
    ...
    this._text_17 = this.renderer.createText(this._el_16,'Save',(null as any));
    ...
    var disposable_5:Function = this.renderer.listen(this._el_13,'click',this.eventHandler(this._handle_click_13_0.bind(this)));
    this.init([],[
      this._text_0,
      this._el_1,
      this._text_2,
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import14.RequiredValidator) && (10 === requestNodeIndex))) { return this._RequiredValidator_10_4; }
    if (((token === import17.NG_VALIDATORS) && (10 === requestNodeIndex))) { return this._NG_VALIDATORS_10_5; }
    if (((token === import18.NG_VALUE_ACCESSOR) && (10 === requestNodeIndex))) { return this._NG_VALUE_ACCESSOR_10_6; }
    if (((token === import15.NgModel) && (10 === requestNodeIndex))) { return this._NgModel_10_7; }
    if (((token === import19.NgControl) && (10 === requestNodeIndex))) { return this._NgControl_10_8; }
    if (((token === import12.NgControlStatus) && (10 === requestNodeIndex))) { return this._NgControlStatus_10_9; }
    if (((token === import11.NgForm) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._NgForm_3_3; }
    if (((token === import20.ControlContainer) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._ControlContainer_3_4; }
    if (((token === import12.NgControlStatusGroup) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._NgControlStatusGroup_3_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_MessageInputComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageInputComponent> {
  if ((renderType_MessageInputComponent === (null as any))) { (renderType_MessageInputComponent = viewUtils.createRenderComponentType('C:/Users/lisac/Documents/Angular2andNodejs/seed-project/assets/app/messages/message-input.component.html',0,import9.ViewEncapsulation.None,styles_MessageInputComponent,{})); }
