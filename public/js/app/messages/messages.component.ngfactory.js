...
var _View_MessagesComponent0 = (function (_super) {
    ...
    _View_MessagesComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_8 = this.renderer.createElement(this._el_6, 'app-message-list', null);
        this._appEl_8 = new import2.AppElement(8, 6, this, this._el_8);
        var compView_8 = import14.viewFactory_MessageListComponent0(this.viewUtils, this.injector(8), this._appEl_8);
        ...
        compView_8.create(this._MessageListComponent_8_4, [], null);
    ...
    _View_MessagesComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.MessageListComponent) && (8 === requestNodeIndex))) {
            return this._MessageListComponent_8_4;
        }
        return notFoundResult;
    };
    _View_MessagesComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._MessageListComponent_8_4.ngOnInit();
        }
...
export function viewFactory_MessagesComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessagesComponent === null)) {
        (renderType_MessagesComponent = viewUtils.createRenderComponentType('C:/Users/lisac/Documents/Angular2andNodejs/seed-project/assets/app/messages/messages.component.ts class MessagesComponent - inline template', 0, import8.ViewEncapsulation.None, styles_MessagesComponent, {}));
    }
